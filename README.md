...
#### 概要
- LuckPermsの`community.[コミュニティ名]`パーミッショングループに所属するプレイヤーに対して、メンバー数に応じたアイテムを配布します
- 配布は隔週金曜日15時に自動実行、または管理者が手動で開始できます
...
# コミュニティパーミッションを付与
lp group setsugen permission set community.setsugen true
...
5. **配布サイクルの開始**
   ...
   /osusowaken start
   ```
   手動で最初の配布サイクルを開始するか、次の隔週金曜日15時まで待ちます。
